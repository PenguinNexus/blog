        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8" style="width:50%">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <h1 class="dark:text-white font-semibold">Create Article</h1>
                </div>
                    ...
                    <div class="grid">
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <form method="post" action="/create">
                                @csrf
                                <label for="title" class="dark:text-white">Title:</label><br>
                                <input type="text" id="title" name="title" class="form-control"><br>
                                <label for="content" class="dark:text-white">Content:</label><br>
